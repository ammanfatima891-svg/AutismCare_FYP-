...
const navigation = [
  ...
  { id: 'patients', label: 'Patients', icon: Users, color: 'text-teal-600' },
...
export function ClinicianDashboard({ user, onLogout }: ClinicianDashboardProps) {
  ...
  const renderSection = () => {
    switch (currentSection) {
      case 'home':
        return <ClinicianHome onNavigate={setCurrentSection} />;
      case 'patients':
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-teal-600 font-bold">AutismCare</h1>
                <p className="text-xs text-gray-500">Clinician Portal</p>
              </div>
            </div>
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-6 py-3 ${
                    isActive ? 'bg-teal-50 border-l-4 border-teal-600' : 'hover:bg-gray-50'
                  }`}
                >
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${
                    isActive
                      ? 'bg-gradient-to-r from-teal-50 to-blue-50 shadow-sm'
                      : 'hover:bg-gray-50'
                  }`}
                >
                  <Icon className={`w-5 h-5 ${isActive ? item.color : 'text-gray-600'}`} />
