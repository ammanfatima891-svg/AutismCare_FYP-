...
import { LabMessages } from './LabMessages';
import { Avatar, AvatarFallback, AvatarImage } from '../ui/avatar';
import { Badge } from '../ui/badge';

type Section = 'home' | 'requests' | 'upload' | 'messages';
...
const navigation = [
  ...
  { id: 'upload', label: 'Upload Results', icon: Upload, color: 'text-purple-600' },
...
export function LabDashboard({ user, onLogout }: LabDashboardProps) {
  ...
  const renderSection = () => {
    switch (currentSection) {
      case 'home':
        return <LabHome onNavigate={setCurrentSection} />;
      case 'requests':
        return <TestRequests />;
      case 'upload':
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-cyan-600 font-bold">AutismCare</h1>
                <p className="text-xs text-gray-500">Laboratory Portal</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                <Avatar>
                  <AvatarImage src="" />
                  <AvatarFallback className="bg-cyan-600 text-white">{initials}</AvatarFallback>
                </Avatar>
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-6 py-3 ${
                    isActive ? 'bg-cyan-50 border-l-4 border-cyan-600' : 'hover:bg-gray-50'
                  }`}
                >
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${
                    isActive
                      ? 'bg-gradient-to-r from-cyan-50 to-blue-50 shadow-sm'
                      : 'hover:bg-gray-50'
                  }`}
                >
                  <Icon className={`w-5 h-5 ${isActive ? item.color : 'text-gray-600'}`} />
