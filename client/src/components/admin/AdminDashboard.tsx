...
import { TherapyTemplates } from './TherapyTemplates';
import { Analytics } from './Analytics';
import { Avatar, AvatarFallback, AvatarImage } from '../ui/avatar';
import { Badge } from '../ui/badge';

type Section = 'home' | 'users' | 'content' | 'templates' | 'analytics';
...
const navigation = [
  ...
  { id: 'users', label: 'Manage Users', icon: Users, color: 'text-blue-600' },
  { id: 'content', label: 'Content Library', icon: BookOpen, color: 'text-purple-600' },
  { id: 'templates', label: 'Therapy Templates', icon: ClipboardList, color: 'text-green-600' },
...
export function AdminDashboard({ user, onLogout }: AdminDashboardProps) {
  ...
  const renderSection = () => {
    switch (currentSection) {
      case 'home':
        return <AdminHome onNavigate={(section: string) => setCurrentSection(section as Section)} />;
      case 'users':
        return <ManageUsers />;
      case 'content':
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-indigo-600 font-bold">AutismCare</h1>
