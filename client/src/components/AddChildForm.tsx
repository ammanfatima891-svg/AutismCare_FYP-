  ...
  return (
    ...
    >
      <Card className="border-0 shadow-xl bg-white/90 backdrop-blur-sm rounded-2xl overflow-hidden">
        <CardHeader className="bg-gradient-to-r from-teal-500/10 to-cyan-500/10 pb-6">
          <motion.div
            initial={{ scale: 0.8 }}
            animate={{ scale: 1 }}
          ...
          >
            ...
            <div>
              <CardTitle className="text-teal-800">Add Child Profile</CardTitle>
              <p className="text-teal-600 text-sm">Create a new child profile for screening</p>
            </div>
          </motion.div>
        </CardHeader>
              ...
              <Form className="space-y-6">
                ...
                >
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-teal-800">Basic Information</h3>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <ErrorMessage name="dateOfBirth" component="p" className="text-xs text-red-500 mt-1" />
                    </div>
                    ...
                    <div>
                      ...
                      >
                        <SelectTrigger className={`mt-1 focus:ring-teal-500 focus:border-teal-500 ${
                      ...
                      <ErrorMessage name="gender" component="p" className="text-xs text-red-500 mt-1" />
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-teal-800">Medical Information</h3>
                  </div>
                  ...
                  <div>
                    ...
                    />
                    <ErrorMessage name="medicalHistory" component="p" className="text-xs text-red-500 mt-1" />
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      />
                      <ErrorMessage name="allergies" component="p" className="text-xs text-red-500 mt-1" />
                    </div>

                    <div>
                      <Label htmlFor="currentMedications" className="text-sm font-medium text-gray-700">
                        Current Medications
                      </Label>
                      <Field
                        as={Textarea}
                      ...
                      />
                      <ErrorMessage name="currentMedications" component="p" className="text-xs text-red-500 mt-1" />
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-teal-800">Emergency Contact</h3>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      />
                      <ErrorMessage name="emergencyContact" component="p" className="text-xs text-red-500 mt-1" />
                    </div>
                    ...
                    <div>
                      ...
                      <ErrorMessage name="emergencyPhone" component="p" className="text-xs text-red-500 mt-1" />
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <Button
                    type="submit"
                    disabled={isSubmitting}
                    className="flex-1 bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-700 hover:to-cyan-700 shadow-lg"
                  >
                    {isSubmitting ? (
                      <>
